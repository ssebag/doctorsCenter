...
<div class="container">
   <div class="card cardAppointment">
    ...
    <div class="card-body">
        <form class="needs-validation" method="POST" action="{{route('doctor.store')}}" enctype="multipart/form-data" novalidate>
           @csrf
            <div class="form-row">
              <div class="col-md-4 mb-3">
                <label for="validationCustom01">Name</label>
                <input type="text" name="name" class="form-control" id="validationCustom01" placeholder="Name" value="" required>
              ...
              <div class="col-md-4 mb-3">
                ...
                <input type="password" class="form-control" name="password" id="validationCustom02" placeholder="Password" value="" required>
                <div class="valid-feedback">
                  Looks good!
                </div>
              </div>
            ...
            <div class="form-row">
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" class="form-control" name="city" id="validationCustom05" placeholder="city" required>
                    <div class="invalid-feedback">
              ...
              <div class="form-row">
                <div class="col-md-6 mb-3">
                  ...
                  <input type="text" class="form-control" name="phone1" id="validationCustom05" placeholder="Phone1" required>
                  <div class="invalid-feedback">
